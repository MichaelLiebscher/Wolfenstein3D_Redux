...
/**
 * \file opengl_extension.c
 * \brief Interface to OpenGL extensions.
...
/**
 * \brief Configure OpenGL extensions
 * \param[in] glext Pointer to string containing the gl extension names.   
 */
