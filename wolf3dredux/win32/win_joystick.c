...
/*
 *      joy_win.c:   Windows joystick input layer
 *      
...
void IN_Commands (void)
{
        ...
        for ( i = 0 ; (unsigned)i < joy_numbuttons ; i++ )
        {
...
void IN_JoyMove( usercmd_t *cmd )
{
	...
	aspeed = speed * ClientStatic.frametime;
        ...
        for (i = 0; i < JOY_MAX_AXES; i++)
        {
                ...
                case AxisForward:
                        if( (joy_advanced->value == 0.0) && mlooking )
                        {
                                ...
                                {               
                                        ...
                                        {
                                                ClientState.viewangles[ PITCH ] -= (fAxisValue * joy_pitchsensitivity->value) * aspeed * cl_pitchspeed->value;
                                        }
                                        else
                                        {
                                                ClientState.viewangles[ PITCH ] += (fAxisValue * joy_pitchsensitivity->value) * aspeed * cl_pitchspeed->value;
                        ...
                        else
                        {
                                ...
                                {
                                        cmd->forwardmove += (short)((fAxisValue * joy_forwardsensitivity->value) * speed * cl_forwardspeed->value);
                                }
                        }
                        break;
                ...
                case AxisSide:
                        ...
                        {
                                cmd->sidemove += (short)((fAxisValue * joy_sidesensitivity->value) * speed * cl_sidespeed->value);
                        }
                        break;
                ...
                case AxisTurn:
                        ...
                        else
                        {
                                ...
                                if( fabs( fAxisValue ) > joy_yawthreshold->value)
                                {
                                        ...
                                        {
                                                ClientState.viewangles[YAW] += (fAxisValue * joy_yawsensitivity->value) * aspeed * cl_yawspeed->value;
                                        }
                                        else
                                        {
                                                ClientState.viewangles[YAW] += (vec_t)((fAxisValue * joy_yawsensitivity->value) * speed * 180.0);
                                        }
                ...
                case AxisLook:
                        if (mlooking)
                        {
                                if( fabs( fAxisValue ) > joy_pitchthreshold->value)
                                {
                                        ...
                                        {
                                                ClientState.viewangles[PITCH] += (vec_t)((fAxisValue * joy_pitchsensitivity->value) * speed * 180.0);
                                        }
                                }
                        }
                        break;
